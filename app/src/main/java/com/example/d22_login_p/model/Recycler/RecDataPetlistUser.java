...
public class RecDataPetlistUser {
    ...
    public Boolean getAllowPrescriptionAccess() {
        return isAllowPrescriptionAccess;
    }

    public void setAllowPrescriptionAccess(Boolean allowPrescriptionAccess) {
        isAllowPrescriptionAccess = allowPrescriptionAccess;
    }
    ...
    public Boolean getRegisteredPetParent() {
        return isRegisteredPetParent;
    }

    public void setRegisteredPetParent(Boolean registeredPetParent) {
        isRegisteredPetParent = registeredPetParent;
    }
